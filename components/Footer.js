    ...
    return(
        <footer className='py-16 px-10 lg:py-10 lg:px-36 bg-black 
            ...
            <div className='flex place-content-center mb-6 lg:mb-0 lg:col-start-1 lg:col-end-4 lg:row-span-1 lg:place-content-start'>
                <Image priority alt='logo' src="/images/logo.svg" width={150} height={28}/>
            </div>
                ...
                <div className='flex w-3/5 sm:w-1/3 lg:w-[90%] xl:w-3/5 justify-between'>
                    <div className='relative'>
                        <div className='hover:cursor-pointer iconHighlight pb-2'>
                            <Image priority alt='facebook' src='/images/icon-facebook.svg' width={25} height={25}/>
                        </div>
                    </div>
                    <div className='relative'>
                        <div className='hover:cursor-pointer iconHighlight pb-2'>
                            <Image priority alt='twitter' className='hover:border-b-4 hover:cursor-pointer' src='/images/icon-twitter.svg' width={25} height={25}/>
                        </div>
                    </div>
                    <div className='relative'>
                        <div className='hover:cursor-pointer iconHighlight pb-2'>
                            <Image priority alt='pinterest' className='hover:border-b-4 hover:cursor-pointer' src='/images/icon-pinterest.svg' width={25} height={25}/>
                        </div>
                    </div>
                    <div className='relative'>
                        <div className='hover:cursor-pointer iconHighlight pb-2'>
                        <Image priority alt='instagram' className='hover:border-b-4 hover:cursor-pointer' src='/images/icon-instagram.svg' width={25} height={25}/>
                        </div>
                    </div>
                </div>
            </div>
